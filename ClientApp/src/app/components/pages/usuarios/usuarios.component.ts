...
const ELEMENT_DATA: Usuario[] = [
  //{ usuario_identificacion: 1, usuario_nombre: "jose mendez", correo: "jose@gmail.com", idRol: 1,rolDescripcion:"Administrador",clave:"1233"},
  //{ usuario_identificacion: 2, usuario_nombre: "leo muñoz", correo: "leo@gmail.com", idRol: 2, rolDescripcion: "Empleado",clave:"4566"},
  //{ usuario_identificacion: 3, usuario_nombre: "yamile pinto", correo: "yamile@gmail.com", idRol: 2, rolDescripcion: "Empleado",clave:"6788"},
  ...
  eliminarUsuario(usuario: Usuario) {
    this.dialog.open(DialogDeleteUsuarioComponent, {
      ...
      if (result === "eliminar") {
        ...
        this._usuarioServicio.deleteUsuario(usuario.identificacion).subscribe({
          next: (data) => {
